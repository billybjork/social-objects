defmodule SocialObjectsWeb.Plugs.SendgridSignature do
  @moduledoc """
  ...
  alias SocialObjectsWeb.Plugs.CacheRawBody
  ...
  defp get_verification_key do
    Application.get_env(:social_objects, :sendgrid_webhook_verification_key)
  end
end
