defmodule SocialObjectsWeb.CreatorComponents do
  @moduledoc """
  Display components and helpers for creator CRM.

  For tag management, see `SocialObjectsWeb.CreatorTagComponents`.
  For tables and modals, see `SocialObjectsWeb.CreatorTableComponents`.
  """
  ...
  def creator_avatar(assigns) do
    ...
    avatar_url =
      case assigns.creator.tiktok_avatar_storage_key do
        ...
        key -> SocialObjects.Storage.public_url(key) || assigns.creator.tiktok_avatar_url
      end
