defmodule SocialObjectsWeb.HostViewComponents do
  @moduledoc """
  ...
  alias SocialObjects.ProductSets.ProductSetProduct
    ...
    <div class="host-product-header">
      ...
      <div class="host-product-header__main">
        ...
        <h1 class="host-product-name">
          ...
          <%= if SocialObjects.Catalog.Product.archived?(@product) do %>
          ...
          <%= for sp <- Enum.sort_by(@session.product_set_products, & &1.position) do %>
            <button
              ...
              class={[
                ...
                SocialObjects.Catalog.Product.archived?(sp.product) && "host-product-card--archived"
              ]}
              phx-click="select_product_from_panel"
              phx-value-position={sp.position}
              title={
                if SocialObjects.Catalog.Product.archived?(sp.product),
                  do: "Archived product",
                  else: nil
              }
            >
