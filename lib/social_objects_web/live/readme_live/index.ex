defmodule SocialObjectsWeb.ReadmeLive.Index do
  @moduledoc """
  ...
  alias SocialObjects.Communications.{Email, Slack}
  alias SocialObjects.Creators
  alias SocialObjects.Outreach.OutreachLog
  alias SocialObjects.ProductSets.ProductSet
  alias SocialObjects.Repo
  alias SocialObjects.Settings
  alias SocialObjects.TiktokLive
  alias SocialObjects.TiktokLive.{BridgeHealthMonitor, Stream}
  ...
  defp openai_configured? do
    key = Application.get_env(:social_objects, :openai_api_key)
    is_binary(key) && key != ""
  end
  ...
  defp integration_card(assigns) do
    ...
    <div class="readme-card readme-card--integration">
      <div class="readme-card__integration-header">
        <img
          src={SocialObjectsWeb.Endpoint.static_path("/images/integrations/#{@logo}")}
          alt={@title}
