defmodule Hudson.AI do
  ...
  alias Hudson.AI.TalkingPointsGeneration
  alias Hudson.Catalog
  alias Hudson.Repo
  alias Hudson.Sessions
  alias Hudson.Workers.TalkingPointsWorker
  ...
  def broadcast_generation_event({event, _} = message)
    ...
    Phoenix.PubSub.broadcast(Hudson.PubSub, "ai:talking_points", message)
  end
  ...
  def broadcast_generation_event(
    ...
    Phoenix.PubSub.broadcast(Hudson.PubSub, "ai:talking_points:#{generation.job_id}", message)
  end
  ...
  def subscribe(job_id \\ nil) do
    ...
    Phoenix.PubSub.subscribe(Hudson.PubSub, topic)
  end
end
