defmodule SocialObjects.TiktokLive.StreamReconciler do
  @moduledoc """
  ...
  alias SocialObjects.TiktokLive.{BridgeClient, Client, Stream}
  ...
  def cancel_stale_stream_jobs do
    ...
    WHERE worker = 'SocialObjects.Workers.TiktokLiveStreamWorker'
  ...
  def cancel_pending_report_jobs(stream_id) do
    ...
    UPDATE oban_jobs
    SET state = 'cancelled', cancelled_at = NOW()
    WHERE worker = 'SocialObjects.Workers.StreamReportWorker'
