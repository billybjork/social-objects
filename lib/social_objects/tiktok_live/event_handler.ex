defmodule SocialObjects.TiktokLive.EventHandler do
  @moduledoc """
  ...
  alias SocialObjects.TiktokLive.{Comment, Stream, StreamProduct, StreamStat}
  ...
  defp upload_thumbnail(stream_id, base64_data) do
    ...
    SocialObjects.Storage.upload_binary(key, binary, "image/jpeg")
  end

  defp auto_link_stream(brand_id, stream_id) do
    case SocialObjects.TiktokLive.auto_link_stream_to_product_set(brand_id, stream_id) do
      {:ok, _session_stream} ->
