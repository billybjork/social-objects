defmodule SocialObjects.Workers.ShopifySyncWorker do
  @moduledoc """
  Oban worker that syncs Shopify product catalog to the database.
  ...
  alias SocialObjects.Shopify.Client
  ...
  We store a single price per product, so we use the minimum
