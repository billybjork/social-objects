defmodule SocialObjects.Workers.StreamReportWorker do
  @moduledoc """
  ...
  defp live_check_enabled? do
    Application.get_env(:social_objects, :verify_stream_live_status, true)
  end

  defp dev_mode? do
    Application.get_env(:social_objects, :env) == :dev
  end
