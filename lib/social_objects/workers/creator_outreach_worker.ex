defmodule SocialObjects.Workers.CreatorOutreachWorker do
  @moduledoc """
  ...
  Called from the /creators LiveView when user sends outreach:
      ...
      SocialObjects.Workers.CreatorOutreachWorker.new(%{
        creator_id: 123,
        template_id: 1
      })
      |> Oban.insert()
  ...
  Or enqueue multiple creators at once:
      ...
      SocialObjects.Workers.CreatorOutreachWorker.enqueue_batch(brand_id, creator_ids, template_id)
  """
  ...
  alias SocialObjects.Communications.Email
