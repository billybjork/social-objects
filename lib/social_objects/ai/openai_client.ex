defmodule SocialObjects.AI.OpenAIClient do
  @moduledoc """
  ...
  defp config, do: Application.get_env(:social_objects, __MODULE__, [])
  ...
  """
  def build_client do
    api_key = Application.get_env(:social_objects, :openai_api_key)
