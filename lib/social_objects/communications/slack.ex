defmodule SocialObjects.Communications.Slack do
  @moduledoc """
  ...
  defp get_config(brand_id) do
    %{
      bot_token: SocialObjects.Settings.get_slack_bot_token(brand_id),
      channel: SocialObjects.Settings.get_slack_channel(brand_id),
      dev_user_id: SocialObjects.Settings.get_slack_dev_user_id(brand_id)
    }
  end

  defp dev_mode? do
    Application.get_env(:social_objects, :dev_routes, false)
  end
