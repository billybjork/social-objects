defmodule SocialObjects.Shopify.ApiTest do
  @moduledoc """
  Quick test module to verify Shopify GraphQL API connectivity and explore available data.

  Usage in iex:
    iex -S mix
    SocialObjects.Shopify.ApiTest.test_connectivity()
    SocialObjects.Shopify.ApiTest.fetch_sample_products()
  """
  ...
  defp get_access_token do
    case Application.get_env(:social_objects, :shopify_access_token) do
      nil ->
        {:error,
  ...
  defp get_store_name do
    case Application.get_env(:social_objects, :shopify_store_name) do
      nil ->
        {:error,
