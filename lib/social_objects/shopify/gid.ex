defmodule SocialObjects.Shopify.GID do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> SocialObjects.Shopify.GID.display_id("gid://shopify/Product/8034117484797")
      "8034117484797"

      iex> SocialObjects.Shopify.GID.display_id("gid://shopify/ProductVariant/12345")
      "12345"

      iex> SocialObjects.Shopify.GID.display_id(nil)
      nil

      iex> SocialObjects.Shopify.GID.display_id("12345")
      "12345"
  """
  ...
  ## Examples
      ...
      iex> SocialObjects.Shopify.GID.to_gid("Product", "8034117484797")
      "gid://shopify/Product/8034117484797"

      iex> SocialObjects.Shopify.GID.to_gid("ProductVariant", "12345")
