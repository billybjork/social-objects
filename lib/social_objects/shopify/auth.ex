defmodule SocialObjects.Shopify.Auth do
  @moduledoc """
  ...
  when API requests return 401 Unauthorized errors. See `SocialObjects.Shopify.Client`
  ...
  ## Examples
      ...
      iex> SocialObjects.Shopify.Auth.get_access_token(brand_id)
      {:ok, "shpat_..."}
  """
  ...
  ## Examples
      ...
      iex> SocialObjects.Shopify.Auth.refresh_access_token(brand_id)
      {:ok, "shpat_..."}
  """
  def refresh_access_token(brand_id) do
    Logger.info("Refreshing Shopify access token using client credentials grant...")

    client_id = SocialObjects.Settings.get_shopify_client_id(brand_id)
    client_secret = SocialObjects.Settings.get_shopify_client_secret(brand_id)
    shop_name = SocialObjects.Settings.get_shopify_store_name(brand_id)
