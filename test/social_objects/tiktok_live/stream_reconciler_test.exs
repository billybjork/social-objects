defmodule SocialObjects.TiktokLive.StreamReconcilerTest do
  @moduledoc """
    ...
    test "cancels jobs across available, scheduled, and retryable states" do
      ...
      {:ok, job1} =
        Repo.insert(%Oban.Job{
          worker: "SocialObjects.Workers.StreamReportWorker",
  ...
  describe "cancel_stale_stream_jobs/0" do
    test "cancels stale TiktokLiveStreamWorker jobs" do
      ...
      {:ok, job} =
        Repo.insert(%Oban.Job{
          worker: "SocialObjects.Workers.TiktokLiveStreamWorker",
